...
def orbit(h,x,y,v_x,v_y,t,m):
    ...
    return Distance_x, Distance_y, Velocity_x, Velocity_y, Time, KEnergy, PEnergy, TEnergy
    ...
    if MyInput == 'a':
        ...
        while MyInput != 'q':                                       #This while loop creates my menu for people using the code to add values 
            ...
            if MyInput == 'a':
                ...
                h = 10
                ''' Plot of the orbit'''
                Distance_x, Distance_y, Velocity_x, Velocity_y, Time, KEnergy, PEnergy, TEnergy = orbit(h,x,y,v_x,v_y,t,m)                
                plt.figure(1)
                ...
                if checkFloat(input_m) and 1e3<=float(input_m)<=1e10 and checkFloat(input_x) and checkFloat(input_y) and checkFloat(input_v_y) and checkFloat(input_v_x): #THESE ONLY ALLOW NUMBERS TO BE INPUTTED
                    ...
                    ''' Plot of the orbit'''
                    Distance_x, Distance_y, Velocity_x, Velocity_y, Time, KEnergy, PEnergy, TEnergy = orbit(h,x,y,v_x,v_y,t,m) #CALLING METHOD ORBIT EQUATION ABOVE                
                    plt.figure(6)
                    plt.plot(Distance_x,Distance_y,linestyle='--',c='r',label='Orbit')
                    plt.scatter(0,0,c='c',s=637.1 )
                    plt.title("Graph of Orbit") 
